...
| `listing/` | `listing-form`, `multi-step-listing-form` (delivery-method-toggle + pickup-locatie velden + koop-toggles + sectie-status-pills + checklist-bar, Fase 27/27.81/27.83), `steps/` (incl. conditionRange UI voor COLLECTION + buy-options + suggested-price, Fase 27.31), `listing-card` (stock-badge "X op voorraad" voor SEALED/OTHER, Fase 27.36), `listing-actions` (status-aware: ACTIVE/PAUSED/RESERVED/PARTIALLY_SOLD knoppen incl. "Advertentie afsluiten", Fase 27.34/27.83), `listing-status-badge` (Fase 27), `buy-quantity-form` (stocked, Fase 27.23), `buy-now-button` (non-stocked FIXED Direct Kopen, Fase 27.33), `sponsored-row` |
