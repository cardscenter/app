-- AlterTable
ALTER TABLE "CartItem" ADD COLUMN "snapshotCardName" TEXT;
ALTER TABLE "CartItem" ADD COLUMN "snapshotPrice" REAL;
...
INSERT INTO "new_ClaimsaleItem" ("buyerId", "cardName", "cardSetId", "claimsaleId", "condition", "createdAt", "id", "imageUrls", "price", "reference", "shippingBundleId", "status", "updatedAt") SELECT "buyerId", "cardName", "cardSetId", "claimsaleId", "condition", "createdAt", "id", "imageUrls", "price", "reference", "shippingBundleId", "status", "updatedAt" FROM "ClaimsaleItem";
