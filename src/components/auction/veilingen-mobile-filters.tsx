...
import { VeilingenFilterSidebar } from "./veilingen-filter-sidebar";
import { countActiveAuctionFilters, parseAuctionFilters } from "@/lib/auction-filters";

interface VeilingenMobileFiltersProps {
  buyerHasPostcode: boolean;
}

export function VeilingenMobileFilters({ buyerHasPostcode }: VeilingenMobileFiltersProps) {
